...
- [x] 04-04-PLAN.md — 문서 3종 (CLIENT_SETUP.md 재작성 + PROTOCOL.md 신규 + RELEASE_NOTES.md)
- [x] 04-05-PLAN.md — CR-01 수정 (harness_server.py) + PITFALLS 17항목 체크리스트 + 수동 검증 checkpoint
**UI hint**: yes
